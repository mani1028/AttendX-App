...
const PrincipalTabBar = ({ state, navigation, isScrollingDown = false }: any) => {
  ...
  const tabs = [
    ...
    { name: 'Staff', label: 'Staff', icon: Users, routeIndex: 1 },
    { name: 'TeacherAssignment', label: 'Assign', icon: UserCheck, routeIndex: 2, isCenter: true },
    { name: 'Students', label: 'Students', icon: GraduationCap, routeIndex: 3 },
    { name: 'Reports', label: 'Reports', icon: BarChart3, routeIndex: 4 },
  ];
    ...
    >
      ...
      <View style={[styles.fabContainer, { top: -(sizes.centerButtonSize / 2) - 4 }]}>
        <Animated.View style={{ transform: [{ scale: pulseAnim }] }}>
          ...
          >
            <UserCheck size={sizes.centerIconSize} color="#fff" />
          </TouchableOpacity>
        </Animated.View>
        <Text style={styles.moreLabel}>Assign</Text>
      </View>
    </Animated.View>
  );
};
...
export default PrincipalTabBar;