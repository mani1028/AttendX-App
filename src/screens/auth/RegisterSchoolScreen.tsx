...
const styles = StyleSheet.create({
  ...
  headerSection: { alignItems: 'center', marginBottom: 30, marginTop: Theme.spacing.xl, width: '100%' },
  logo: { width: 300, height: 100, marginBottom: Theme.spacing.md, alignSelf: 'center' },
  brandSubtitle: { ...Theme.typography.body, color: Theme.colors.textSec, textAlign: 'center', lineHeight: 20, paddingHorizontal: Theme.spacing.xl },
  card: { backgroundColor: Theme.colors.card, padding: Theme.spacing.xl, borderRadius: Theme.radius.xxl, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 5 },
  cardTitle: { fontSize: Theme.typography.h3.fontSize, fontWeight: '700', color: '#1E293B', textAlign: 'center' },
  ...
  boardOptions: { flexDirection: 'row', flexWrap: 'wrap', gap: Theme.spacing.xs },
  boardBtn: { paddingVertical: Theme.spacing.sm, paddingHorizontal: 10, borderRadius: Theme.radius.sm, backgroundColor: Theme.colors.background, borderWidth: 1, borderColor: Theme.colors.border },
  boardBtnActive: { backgroundColor: Theme.colors.blue, borderColor: Theme.colors.blue },
  ...
  generatedCode: { ...Theme.typography.caption, fontWeight: '700', color: Theme.colors.blue, marginBottom: Theme.spacing.md, marginTop: -8, textAlign: 'right' },
  emailContainer: { flexDirection: 'row', alignItems: 'flex-end', gap: Theme.spacing.sm },
  otpSection: { flexDirection: 'row', alignItems: 'flex-end', gap: Theme.spacing.sm, marginTop: Theme.spacing.sm },
  inlineVerifyBtn: { height: 48, backgroundColor: Theme.colors.blue, borderRadius: Theme.radius.md, paddingHorizontal: Theme.spacing.md, justifyContent: 'center', marginBottom: Theme.spacing.md },
  inlineVerifyBtnText: { color: Theme.colors.card, ...Theme.typography.caption, fontWeight: '700' },
  btnDisabled: { opacity: 0.5 },
  actionButton: { height: 56, borderRadius: Theme.radius.lg, backgroundColor: Theme.colors.blue, marginTop: Theme.spacing.md },
  ...
  successIcon: { width: 60, height: 60, borderRadius: Theme.radius.xxxl, backgroundColor: '#DCFCE7', alignItems: 'center', justifyContent: 'center', marginBottom: Theme.spacing.md },
  successIconText: { fontSize: 30, color: '#16A34A' },
  successDetails: { width: '100%', backgroundColor: Theme.colors.background, borderRadius: Theme.radius.lg, padding: Theme.spacing.md, marginVertical: Theme.spacing.xl, gap: Theme.spacing.md },
  detailItem: { borderBottomWidth: 1, borderBottomColor: Theme.colors.border, paddingBottom: Theme.spacing.sm },
  detailLabel: { fontSize: Theme.typography.label.fontSize, fontWeight: '800', color: Theme.colors.textMuted, letterSpacing: 1 },
  detailValue: { fontSize: Theme.typography.h2.fontSize, fontWeight: '800', color: '#1E293B' },
  detailValueSmall: { ...Theme.typography.h4, color: Theme.colors.textSec },
  successCountdown: { ...Theme.typography.caption, color: Theme.colors.textMuted, marginTop: Theme.spacing.md },
});
